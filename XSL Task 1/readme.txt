...
Поддержка многоязычности предполагается на уровне базы данных. То есть все данные мы уже получаем на нужном языке. Все выводимая на экран информация получается из XML.
...
XSL схема для обработки сообщений:
	...
	formandmessage.xsd - схема для валидации. Рисовалась в XMLSpy 
